...
import { FileHeart, Heart, LayoutDashboard, Settings } from "lucide-react";
...
const menuItems: MenuItem[] = [
  {
    icon: Settings,
    label: "UpdateProfile",
    link: "/frontend/EventOrganizer/UpdateProfile",
  },
  {
    icon: FileHeart,
    label: "Events",
    link: "/frontend/EventOrganizer/Events",
  },
  {
    icon: Heart,
    label: "Send Donor",
    link: "/frontend/EventOrganizer/sendDonor",
  },
  {
    icon: LayoutDashboard,
    label: "Dashboard",
    link: "/frontend/EventOrganizer/Dashboard",
  },
];
      ...
      <div className="flex flex-col mt-5 w-full">
        {menuItems.map((item, index) => (
          <Link href={item.link} key={index} className="w-full no-underline">
            <div
              className={`flex items-center w-full h-16 space-x-4 hover:bg-green-800 ${
