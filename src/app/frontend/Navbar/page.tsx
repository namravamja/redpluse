...
const options = [
    { name: 'Looking for Blood', href: '/frontend/Looking-For-Blood/ViewBloodBank' },
    { name: 'Want to Donate Blood', href: '/frontend/Login/Donor' },
    { name: 'Organize Event', href: '/frontend/Login/EventOrganizer' },
    { name: 'Blood Bank', href: '/frontend/Login/BloodBank' },
];
