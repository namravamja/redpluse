...
import { useResetPasswordMutation } from "@/app/lib/EventOrganizer"; // RTK Query API
...
export default function ResetPassword() {
  ...
  const handleResetPassword = async () => {
    ...
    try {
      ...
      setTimeout(() => router.push("/frontend/Login/EventOrganizer"), 3000); // Redirect after success
    } catch (error: unknown) {
      if (
