          ...
          <SelectContent className="max-h-64">
            {selectedState && (
              <Button
                ...
                className="w-full justify-start text-blue-600/100 hover:text-blue-700/100 hover:bg-blue-50 mb-1"
              >
                Clear Selection
              </Button>
            )}
        ...
        <CardContent className="p-0 sm:p-6">
          {isLoading ? (
            <div className="flex justify-center p-10">
              <Loader2 className="h-8 w-8 animate-spin text-blue-600/100" />
            </div>
